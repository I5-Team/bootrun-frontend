...
export default function AdminPageLayout({ title, rightElement, children }: AdminPageLayoutProps) {
  return (
    <>
      <S.PageHeader>
      ...
      <S.ContentLayout aria-labelledby="page-title">{children}</S.ContentLayout>
    </>
  );
}
