...
export default function Banner() {
    ...
    const bannerDatas: BannerItem[] = [
        {
            id: 1,
            imgSrc: `${BASE_URL}images/banner-main-2-desktop.webp`,
            mobileImgSrc: `${BASE_URL}images/banner-main-2-mobile.webp`,
            tag: '부트런 사이트 오픈!',
            title: `부트런 사이트\n오픈했습니다!`,
        ...
        {
            id: 2,
            imgSrc: `${BASE_URL}images/banner-main-1-desktop.webp`,
            mobileImgSrc: `${BASE_URL}images/banner-main-1-mobile.webp`,
            tag: '부트캠프 수료',
            title: "부트캠프 수료를\n진심으로 축하드립니다",
            desc: '수료한지 오늘로부터 ',
        ...
        {
            id: 3,
            imgSrc: `${BASE_URL}images/banner-main-3-desktop.webp`,
            mobileImgSrc: `${BASE_URL}images/banner-main-3-mobile.webp`,
            tag: '생일을 축하합니다',
            title: "11월 9일은\n채현님의 생일",
            desc: "지났지만 축하드립니다 🎉",
        }
        ...
        >
            {bannerDatas.map((bannerItem, index) => (
                ...
                >
                    <ImageWrapper>
                        <StyledPicture>
                            <source media="(max-width: 480px)" srcSet={bannerItem.mobileImgSrc} type="image/webp" />
                            <img
