...
import type { CourseItem, CoursesApiParams, MyEnrollmentItem, MyEnrollmentsApiParams } from "../types/CourseType";
...
export const fetchCourses = async (
    ...
    try {
    const response = await apiClient.get(API_URL.COURSE.COURSE_LIST, { params });
