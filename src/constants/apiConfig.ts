...
export const API_URL = {
    ...
    COURSE : {
        ...
        LECTURES: (courseId: number, chapterId: number) => `/courses/${courseId}/chapters/${chapterId}/lectures`, // 강의 영상 목록 조회 (GET)
    },  
    /* 수강 등록 및 학습 진행 */
    ENROLLMENT : {
    ...
    QNA : {
        ...
        UPDATE_COMMENT: (questionId: number, commentId: number) => `/questions/${questionId}/comments/${commentId}`, // 답변 수정 (PATCH)
        DELETE_COMMENT: (questionId: number, commentId: number) => `/questions/${questionId}/comments/${commentId}`, // 답변 삭제 (DELETE)
    },
    ...
    ADMIN_COURSES : {
        ...
        UPDATE_CHAPTER: (courseId: number, chapterId: number) => `/admin/courses/${courseId}/chapters/${chapterId}`, // 챕터 수정 (PATCH)
        DELETE_CHAPTER: (courseId: number, chapterId: number) => `/admin/courses/${courseId}/chapters/${chapterId}`, // 챕터 삭제 (DELETE)
        ADD_LECTURE: (courseId: number, chapterId: number) => `/admin/courses/${courseId}/chapters/${chapterId}/lectures`, // 강의 영상 추가 (POST)
        UPDATE_LECTURE: (courseId: number, chapterId: number, lectureId: number) => `/admin/courses/${courseId}/chapters/${chapterId}/lectures/${lectureId}`, // 강의 영상 수정 (PATCH)
        DELETE_LECTURE: (courseId: number, chapterId: number, lectureId: number) => `/admin/courses/${courseId}/chapters/${chapterId}/lectures/${lectureId}`, // 강의 영상 삭제 (DELETE)
