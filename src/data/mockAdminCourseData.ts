...
export const mockCourses: CourseListItem[] = [
  {
    ...
    description: '리액트의 모든 것을 배우는 강의입니다. 컴포넌트, 훅, 상태관리, 라우팅까지 실무에 필요한 모든 내용을 다룹니다.',
    ...
    price_type: 'paid',
    price: 50000,
    total_duration: 36000, // 10시간
    faq: JSON.stringify([
      { question: '수강 기간은 얼마나 되나요?', answer: '결제 후 2년간 무제한 수강 가능합니다.' },
      { question: '환불이 가능한가요?', answer: '구매일 7일 이내, 진도율 10% 미만일 경우 환불 가능합니다.' },
    ]),
    is_published: true,
  ...
  },
  {
    ...
    price_type: 'free',
    price: 0,
    total_duration: 25200, // 7시간
    faq: JSON.stringify([]),
    is_published: true,
    created_at: '2025-01-22T00:00:00Z',
    updated_at: '2025-02-01T00:00:00Z',
    total_chapters: 9,
    total_enrollments: 421,
  },
  {
    id: 9,
    category_type: 'ai',
  ...
  },
  {
    ...
    price_type: 'free',
    price: 0,
    total_duration: 18000, // 5시간
    faq: JSON.stringify([]),
    is_published: true,
    created_at: '2025-01-28T00:00:00Z',
    updated_at: '2025-02-07T00:00:00Z',
    total_chapters: 7,
    total_enrollments: 512,
  },
  {
    id: 11,
    category_type: 'backend',
