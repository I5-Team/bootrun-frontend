...
export const mockCourses: (CourseListItem & Record<string, unknown>)[] = [
  {
    ...
    instructor_description: '네이버, 카카오에서 프론트엔드 개발을 담당했으며, React 전문가로 다수의 프로젝트를 리딩한 경험이 있습니다.',
    instructor_image: '/images/instructor1.jpg',
    price_type: 'paid',
    price: 50000,
    access_duration_days: 730, // 2년
    max_students: 100,
    recruitment_start_date: '2025-01-01T00:00:00Z',
    recruitment_end_date: '2025-12-31T23:59:59Z',
    course_start_date: '2025-01-15T00:00:00Z',
    course_end_date: '2025-03-15T23:59:59Z',
    student_reviews: JSON.stringify([
      { student: '홍길동', review: '정말 유익한 강의였습니다!' },
      { student: '김철수', review: 'React를 처음 배웠는데 이해가 쏙쏙 됩니다.' },
    ]),
  ...
  },
  {
    ...
    instructor_description: 'Node.js 오픈소스 프로젝트에 다수 기여하였으며, 대규모 백엔드 시스템 구축 경험이 풍부합니다.',
    instructor_image: '/images/instructor2.jpg',
    price_type: 'paid',
    price: 65000,
    access_duration_days: 365,
    max_students: 50,
    recruitment_start_date: '2025-01-05T00:00:00Z',
    recruitment_end_date: '2025-12-31T23:59:59Z',
    course_start_date: '2025-01-20T00:00:00Z',
    course_end_date: '2025-04-20T23:59:59Z',
    student_reviews: JSON.stringify([]),
